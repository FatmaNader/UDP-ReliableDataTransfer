...
//            String pckts = new String(receivePacket.getData());
            ...
            System.out.println("the New client Socket " + NClientSocket);

            System.out.println("the packets needed is:" + packets_needed);
...
//            String pckts = new String(receivePacket.getData());
        ...
        System.out.println("THE FILE IS RECIEVED");
        ...
        while ( SequenceNum < packets_needed) {
            ...
            while (curr_sheckSum != expected_checkSum || seq_no != SequenceNum) {
                if (curr_sheckSum != expected_checkSum) {
                    System.out.println("+++++++++WRONG CHECK SUM ++++++++++++");
                }
                if (seq_no != SequenceNum) {
                    System.out.println("+++++++++WRONG SEQ NO +++++++++");
                }
