...
public class ClientSW {
    ...
    public static int MainServer = 9876;//main server
...
//                sendAck(clientSocket, type, w);
            ...
            byte type = 1;
            sendAck(clientSocket, w);

        }
        // System.out.println(" GET FILE COMPLETED");
    }

    public static void sendAck(DatagramSocket clientSocket, int expected_seqNo) throws UnknownHostException, IOException {
        ...
        DatagramPacket sendPacket = new DatagramPacket(Ack, Ack.length, IPAddress, ThreadServer);
        clientSocket.send(sendPacket);
    }
