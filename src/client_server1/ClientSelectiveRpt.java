...
//    }
    ...
    public static void run(){
        try {
            ...
            PRINT("Welcome to selective repeat client!", 1);
            PRINT("-------------------------------------", 1);
            PRINT("->Please enter filename to request: ", 1);
...
//            String pckts = new String(receivePacket.getData());
                ...
                PRINT("The new client socket is: " + NClientSocket, 1);
                PRINT("The packets needed to get file is:" + packets_needed, 1);
                System.out.println("-----------------------------------------------------------------------------------------------------------------");
                System.out.println("-----------------------------------------------------------------------------------------------------------------");
